...
```bash
dimap@dima5778 MINGW64:~/Desktop/confupr$ ./6.sh 
...
```bash
dimap@dima5778 MINGW64 ~/downloads ./tar.sh "test" "py"
...
```
```bash
dimap@dima5778 MINGW64:~/Desktop/confupr$ ./6.sh test.c test_new.c
...
```
```bash
dimap@dima5778 MINGW64 ~/downloads ./10.sh test
test/3.js
test/1.py
test/1ff
test/2.py
